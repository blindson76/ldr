...
func (c *maintainClient) FormatDisks(ctx context.Context, in *PartitionRequest, opts ...grpc.CallOption) (Maintain_FormatDisksClient, error) {
	stream, err := c.cc.NewStream(ctx, &Maintain_ServiceDesc.Streams[1], "/loader.Maintain/FormatDisks", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *maintainClient) ApplyImage(ctx context.Context, in *ApplyImageRequest, opts ...grpc.CallOption) (Maintain_ApplyImageClient, error) {
	stream, err := c.cc.NewStream(ctx, &Maintain_ServiceDesc.Streams[2], "/loader.Maintain/ApplyImage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *maintainClient) BCDFix(ctx context.Context, in *BCDFixRequest, opts ...grpc.CallOption) (*BCDFixResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loader.Maintain/BCDFix", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Maintain_BCDFix_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loader.Maintain/BCDFix",
	}
...
type LoaderClient interface {
	...
	BootEntries(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BootEntryResponse, error)
}
...
func (c *loaderClient) BootEntries(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*BootEntryResponse, error) {
	out := new(BootEntryResponse)
	err := c.cc.Invoke(ctx, "/loader.Loader/BootEntries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoaderServer interface {
	...
	BootEntries(context.Context, *Empty) (*BootEntryResponse, error)
...
func (UnimplementedLoaderServer) BootEntries(context.Context, *Empty) (*BootEntryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method BootEntries not implemented")
}
...
func _Loader_BootEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LoaderServer).BootEntries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loader.Loader/BootEntries",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoaderServer).BootEntries(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Loader_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BootEntries",
			Handler:    _Loader_BootEntries_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/loader.proto",
